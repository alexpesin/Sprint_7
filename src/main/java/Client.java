...
public class Client {
    ...
    protected RequestSpecification getSpecification(){
        return new RequestSpecBuilder()
                ...
                //.and().setAuth().oauth2("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmNiMDMyZTA0NmM5ZDAwM2QxNmY2MWUiLCJpYXQiOjE2NzI2OTk1OTMsImV4cCI6MTY3MzMwNDM5M30.jMwmUemEWN0GnoxBxP-ot-aspBmZsUrLYR0o5u0P-uA")
                .build();
    }
}
